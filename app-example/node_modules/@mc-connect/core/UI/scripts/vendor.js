...
+function ($) {
  ...
  Modal.prototype.adjustDialog = function () {
    ...
    this.$element.css({
      /*
      paddingLeft:  !this.bodyIsOverflowing && modalIsOverflowing ? 0 : this.scrollbarWidth,
      paddingRight: this.bodyIsOverflowing && !modalIsOverflowing ? 0 : this.scrollbarWidth
      */
        // That padding is not required with smart scrollbars, causing mis-alignments
        paddingLeft:  !this.bodyIsOverflowing && modalIsOverflowing ? 0 : 0,
        paddingRight: this.bodyIsOverflowing && !modalIsOverflowing ? 0 : 0
    })
  }
